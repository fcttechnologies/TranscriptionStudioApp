...
@MainActor
public final class RecordingLocationProvider {
    ...
    public struct CapturedLocation: Sendable, Equatable {
...
public struct PlaceNameComponents: Sendable, Equatable {
    /// A landmark / business name, only when the map item is a categorized point of interest
    /// ("Blue Bottle Coffee").
    public var pointOfInterest: String?
    ...
    public init(pointOfInterest: String? = nil, city: String? = nil, shortAddress: String? = nil) {
...
public enum PlaceNameFormatter {
    public static func shortName(from components: PlaceNameComponents) -> String? {
