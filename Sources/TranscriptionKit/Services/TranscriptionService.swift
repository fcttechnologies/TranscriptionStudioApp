...
public final class TranscriptionService {
    ...
    public static let fileJobSteps = ["Preparing", "Reading file", "Transcribing", "Saving"]
    ...
    public static let urlJobSteps = ["Preparing", "Downloading audio", "Transcribing", "Saving", "Cleaning up"]
    ...
    public init(asrEngine: any AsrEngine,
