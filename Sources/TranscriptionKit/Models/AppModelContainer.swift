...
public enum AppModelContainer {
    public nonisolated static let appGroupID = "group.com.fcttechnologies.TranscriptionStudio"
    ...
    public static var schema: Schema { Schema(versionedSchema: TranscriptionSchemaCurrent.self) }
    ...
    public nonisolated static func syncStateFileURL() throws -> URL {
    ...
    public nonisolated static func blobStateFileURL() throws -> URL {
        try configuration.storeURL()
            .deletingLastPathComponent()
    ...
    public nonisolated static func blobCacheDirectory() throws -> URL {
        try configuration.storeURL()
            .deletingLastPathComponent()
