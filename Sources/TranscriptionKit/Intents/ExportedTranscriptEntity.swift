...
public struct ExportedTranscriptFileEntity: FileEntity, OwnershipProvidingEntity {
    ...
    public var id: FileEntityIdentifier

    @Property(title: "Title")
    public var title: String

    public init(id: FileEntityIdentifier, title: String) {
        self.id = id
        self.title = title
    }
    ...
    public var ownership: EntityOwnership { .shared }

    public static let defaultQuery = ExportedTranscriptFileQuery()
}
...
public struct ExportedTranscriptFileQuery: EntityQuery {
    public init() {}

    public func entities(for identifiers: [FileEntityIdentifier]) async throws -> [ExportedTranscriptFileEntity] {
