...
public struct AddEventToCalendarIntent: AppIntent {
    public static let title: LocalizedStringResource = "Add Meeting to Calendar"
    ...
    public static var parameterSummary: some ParameterSummary { Summary("Add an event from \(\.$session) to Calendar") }
...
/// items.
public struct AddActionItemReminderIntent: AppIntent {
    public static let title: LocalizedStringResource = "Add Action Item to Reminders"
    public static let description = IntentDescription(
        "Review an action item found in a transcript and add it to Reminders.")
    public static let supportedModes: IntentModes = .foreground(.dynamic)
    public static var parameterSummary: some ParameterSummary { Summary("Add an action item from \(\.$session) to Reminders") }
