...
public enum TranscriptLibraryAssistant {
    ...
    public static var isAvailable: Bool { SemanticAssistant.currentAvailability().isAvailable }

    /// Build the assistant: TS instructions + a Spotlight RAG tool over the app's named index with
    /// full-text hydration.
    public static func makeAssistant() -> SemanticAssistant {
    ...
    public static func ask(_ question: String) async -> Result<String, SemanticAssistant.AskError> {
