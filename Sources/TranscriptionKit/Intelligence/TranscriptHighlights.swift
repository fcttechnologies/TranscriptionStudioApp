...
public struct SessionHighlights: Sendable, Equatable {
    ...
    public var actionItems: [ExtractedActionItem]
...
@Generable
public struct ExtractedActionItem: Sendable, Equatable {
    ...
    public init(task: String, owner: String = "", dueDateText: String = "") {
        self.task = task
        self.owner = owner
...
public struct ExtractedEvent: Sendable, Equatable {
    ...
    public init(title: String, dateText: String = "", attendees: [String] = []) {
        self.title = title
