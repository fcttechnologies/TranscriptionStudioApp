...
public struct SortformerMel: Sendable {
    ...
    public static let preemph: Float = 0.97
    public static let logGuard = Float(pow(2.0, -24))   // 5.9604645e-08 (metadata.json log_guard)
    public static let padTo = 16
    ...
    public func linearMel(_ samples: [Float]) -> (mel: [Float], frames: Int) {
