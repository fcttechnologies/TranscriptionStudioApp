...
public enum PipelineStateLabel {
    ...
    public static let stateDomain = "com.fcttechnologies.TranscriptionStudio.pipeline"
    ...
    public static func label(for stage: PipelineStage) -> String? {
        switch stage {
