...
public struct CalendarDraft: Equatable, Sendable {
...
public struct ReminderDraft: Equatable, Sendable {
    ...
    public init(title: String, notes: String, dueDate: Date? = nil) {
        self.title = title
        self.notes = notes
...
public enum EventDraftMapper {
    /// Default length for an event whose end time wasn't extracted — one hour.
    public static let defaultEventDuration: TimeInterval = 3600
    ...
    public static func calendarDraft(title: String, date: Date?, dateText: String,
    ...
    public static func reminderDraft(task: String, owner: String?, dueDate: Date?, dueDateText: String?,
    ...
    /// core above.
    public static func calendarDraft(for event: TranscriptEvent, sessionTitle: String,
    ...
    public static func reminderDraft(for item: TranscriptActionItem, sessionTitle: String) -> ReminderDraft {
