...
public struct ActionSuggestion: Identifiable, Equatable, Sendable {
...
public enum ActionSuggestions {
    public static func eventSuggestionID(_ id: UUID) -> String { "event:\(id.uuidString)" }
    public static func reminderSuggestionID(_ id: UUID) -> String { "reminder:\(id.uuidString)" }
    public static func contactSuggestionID(_ id: UUID) -> String { "contact:\(id.uuidString)" }
    ...
    @MainActor
    public static func suggestions(for session: TranscriptSession,
    ...
    @MainActor
    public static func dismiss(_ id: String, on session: TranscriptSession,
