...
public struct CaptionLine: Identifiable, Equatable {
    ...
    public init(id: String, speaker: SpeakerID, speakerLabel: String?, text: String, isProvisional: Bool) {
        self.id = id
...
public enum LiveCaptionBuilder {
    ...
    public static let defaultWindow = 6
    ...
    public static func lines(from segments: [AttributedSegment],
