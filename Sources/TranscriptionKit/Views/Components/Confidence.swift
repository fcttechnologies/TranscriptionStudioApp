...
public struct ConfidenceSpan: Equatable, Sendable {
    public let text: String
    public let isLowConfidence: Bool

    public init(text: String, isLowConfidence: Bool) {
        self.text = text
...
public enum Confidence {
    ...
    public static func wordScore(_ probability: Float) -> Float {
    ...
    public static func spans(text: String,
                             words: [AsrWord]?,
                             segmentScore: Float,
