...
@MainActor
public struct TranscriptionSyncConfiguration {
    public var stateFileURL: () throws -> URL
    public var blobStateFileURL: () throws -> URL
    public var blobCacheDirectory: () throws -> URL
    public var makeTransport: (any SyncAccount) -> any SyncTransport
    public var makeBlobTransport: (any SyncAccount) -> any BlobTransport
    ...
    public var makeTriggers: (ModelContainer) -> [any HistoryChangeTrigger]
    ...
    public static var live: TranscriptionSyncConfiguration {
...
public final class TranscriptionSync {
    ...
    /// only here.
    @ObservationIgnored public var onRemoteChanges: (@MainActor () -> Void)?
    ...
    public init(configuration: TranscriptionSyncConfiguration = .live) {
    ...
    public func start(controller: AccountController, container: ModelContainer) {
    ...
    public func recordingData(for asset: AssetSource) async throws -> Data? {
    ...
    /// fetching state.
    public func cachedRecordingData(for asset: AssetSource) -> Data? {
        guard let blobStore, let ref = asset.blobRef else { return nil }
    ...
    public func discardRecording(_ asset: AssetSource?) {
