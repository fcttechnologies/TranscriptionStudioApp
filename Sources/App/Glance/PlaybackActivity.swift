...
nonisolated struct PlaybackActivityAttributes: ActivityAttributes, Sendable {
    struct ContentState: Codable, Hashable, Sendable {
        ...
        init(title: String, isPlaying: Bool, duration: TimeInterval,
    ...
    init(sessionID: UUID, kindLabel: String, kindSystemImage: String) {
...
nonisolated enum PlaybackClock {
    ...
    static func wallClockSpan(position: TimeInterval,
