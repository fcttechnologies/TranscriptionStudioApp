...
enum RemoteJobClaim {
    ...
    static func decide(kind: SessionKind,
...
enum MacPresenceStatus: Equatable, Sendable {
    ...
    static func evaluate(lastSeen: Date?, now: Date, freshWithin: TimeInterval) -> MacPresenceStatus {
