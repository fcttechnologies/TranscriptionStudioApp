...
struct GraphTensor: Sendable, Equatable {
    let values: [Float]
    let shape: [Int]
...
final class CoreAIGraphRunner: GraphRunner, @unchecked Sendable {
    ...
    init(modelURL: URL, function name: String = "main") async throws {
