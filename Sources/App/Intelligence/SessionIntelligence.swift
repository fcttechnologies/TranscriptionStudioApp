...
enum IntelligenceUnavailable: Sendable, Equatable {
...
struct SessionIntelligence: Sendable {
    ...
    init(statusProvider: @escaping @Sendable () -> IntelligenceStatus =
    ...
    var status: IntelligenceStatus { statusProvider() }
    ...
    static func currentStatus() -> IntelligenceStatus {
        #if canImport(FoundationModels)
