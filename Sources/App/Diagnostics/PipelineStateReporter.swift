...
protocol PipelineStateReporting: Sendable {
...
final class PipelineStateReporter: PipelineStateReporting {
    ...
    init(transition: @escaping @Sendable (String?) -> Void) {
    ...
    static let shared = PipelineStateReporter()
