...
enum SpeakerID: Sendable, Codable, Hashable {
...
struct AttributedSegment: Sendable, Identifiable, Equatable {
    var id: String { asr.id }
    ...
    init(asr: AsrSegment, speaker: SpeakerID, speakerConfidence: Float, isProvisional: Bool) {
        self.asr = asr
...
enum TranscriptFuser {
    ...
    static func attribute(asr: [AsrSegment],
                                 turns: [SpeakerTurn],
                                 micIsMe: Bool = false,
