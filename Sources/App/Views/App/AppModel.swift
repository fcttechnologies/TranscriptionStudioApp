...
final class AppModel {
    ...
    let loadSampler: SystemLoadSampler
    ...
    @ObservationIgnored weak var sync: TranscriptionSync?
    ...
    /// recording sheet.
    func requestRecording(mode: RecordingController.Mode) {
    ...
    func startReadAloud(session: TranscriptSession) {
        playback.unload()
    ...
    private(set) var enginePrewarmState: EnginePrewarmState = .idle
    ...
    func submitLink(urlString: String, title: String) {
    ...
    func startMacCompanionServices() {
...
enum EnginePrewarmState: Equatable, Sendable {
    case idle
...
enum TranscriptionSource: Sendable {
    case url(String)
