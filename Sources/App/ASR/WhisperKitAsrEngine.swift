...
actor WhisperKitAsrEngine: AsrEngine {
    ...
    static let defaultModelNameMac = "openai_whisper-large-v3-v20240930_turbo"
    static let defaultModelNameiOS = "openai_whisper-large-v3-v20240930_turbo"

    static var platformDefaultModelName: String {
        #if os(macOS)
        defaultModelNameMac
        #else
        defaultModelNameiOS
    ...
    init(modelName: String = WhisperKitAsrEngine.platformDefaultModelName,
    ...
    static var platformDefaultUseBackgroundDownloadSession: Bool {
        #if os(iOS)
        true
        #else
        false
