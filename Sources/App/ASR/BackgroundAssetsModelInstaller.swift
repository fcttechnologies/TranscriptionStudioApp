...
enum BackgroundAssetsModelInstaller {
    ...
    @discardableResult
    static func installStagedModel(
    ...
    @discardableResult
    static func startForegroundDownload(
        appGroupContainer: URL? = AppGroup.containerURL,
        downloadBase: URL = WhisperKitAsrEngine.defaultDownloadBase(),
...
enum BackgroundAssetsInstallerError: LocalizedError, Sendable {
...
final class ForegroundDownloadSession: NSObject, BADownloadManagerDelegate, @unchecked Sendable {
