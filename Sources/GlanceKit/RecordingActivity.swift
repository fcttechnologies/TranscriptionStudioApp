...
public nonisolated struct RecordingActivityAttributes: ActivityAttributes, Sendable {
    public struct ContentState: Codable, Hashable, Sendable {
        ...
        public init(timerAnchor: Date?, elapsed: TimeInterval, isPaused: Bool, levels: [UInt8]) {
