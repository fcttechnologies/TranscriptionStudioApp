...
public enum IngestDropBoxError: LocalizedError, Sendable {
...
public enum IngestDropBox {
    ...
    @discardableResult
    public static func stageFile(from sourceURL: URL,
                                 title: String,
    ...
    @discardableResult
    public static func stageURL(_ urlString: String,
                                title: String,
                                container: URL? = nil) throws -> PendingIngest {
        let container = try resolveContainer(container)
    ...
    public static func drain(container: URL? = nil) -> [PendingIngest] {
    ...
    public static func stagedFileURL(for item: PendingIngest, container: URL? = nil) -> URL? {
    ...
    public static func remove(_ item: PendingIngest, container: URL? = nil) {
        guard let container = try? resolveContainer(container) else { return }
