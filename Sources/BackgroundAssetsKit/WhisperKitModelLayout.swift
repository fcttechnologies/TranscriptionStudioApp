...
public enum WhisperKitModelLayout {
    public static let huggingFaceHost = "huggingface.co"

    /// The remote HuggingFace URL for a single asset.
    public static func downloadURL(repo: String, variant: String, relativePath: String) -> URL? {
    ...
    public static func installRelativePath(repo: String, variant: String, relativePath: String) -> String {
        "models/\(repo)/\(variant)/\(relativePath)"
    }

    /// The root under the App Group container where the extension stages finished files.
    public static func stagingRoot(appGroupContainer: URL) -> URL {
    ...
    public static func stagedURL(appGroupContainer: URL, installRelativePath: String) -> URL {
    ...
    public static func installedURL(downloadBase: URL, installRelativePath: String) -> URL {
    ...
    public static func pendingAssets(
